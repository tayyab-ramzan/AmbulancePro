			...
			<div class="container">
				...
				<div class="main">
					...
					<section class="cols" align="center">
							...
							<div class="contenu">
								<form class= "form1" action="ajouter_vehicule.html" method="POST">
									<label>Numéro d'Immatriculation:</label><input type="text" name = "immatricule" id="immatricule" value=${ data.immatricule }>${ data.errors.immatricule }
									<br>
